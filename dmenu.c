...
/* enums */
enum { SchemeNorm, SchemeSel, SchemeNormHighlight, SchemeSelHighlight ,SchemeHp, SchemeOut, SchemeLast }; /* color schemes */
...
usage(void)
{
	die("usage: dmenu [-bfiv] [-l lines] [-p prompt] [-fn font] [-m monitor]\n"
	    ...
	    "             [-nhb color] [-nhf color] [-shb color] [-shf color] [-hb color] [-hf color] [-hp items] [-w windowid]\n", stderr);
}
